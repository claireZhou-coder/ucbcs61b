...
/*
1. constructor - reuse code 其他的构造函数都调用没有参数的最基本的构造函数
2. static域计算numberOfFractions，所有的Fraction objects访问同一个参数值
辗转相除法求最大公约数，以此方法来将fraction变为reduced form, 最后用toString输出最简形式
*/
import java.io.*;
