...
public class Homework3 {
  ...
  **/
  ...
  public static void smoosh(int[] ints) {
    ...
    //solution from 1p3a 
    //https://www.1point3acres.com/bbs/forum.php?mod=redirect&goto=findpost&ptid=97838&pid=1591328
    for (int j = 1; j < size; j++) {
      if (ints[curIndex] != ints[j]) {
        ints[curIndex+1] = ints[j];
        curIndex+=1;
      }
    }
