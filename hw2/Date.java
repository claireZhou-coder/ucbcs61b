...
class Date {
  ...
  public String toString() {
      return this.month + "/" + this.date + "/" + this.year;                      // replace this line with your solution
  }
  ...
  public boolean isAfter(Date d) {
      boolean sameDate = this.date == d.date && this.month == d.month && this.year == d.year;
      if (!isBefore(d) && !sameDate) {
        return true;
      }
      else { 
        return false;
  ...
  public int difference(Date d) {
      int priorYear = d.year;
      int latterYear = this.year;
      int d1 = this.dayInYear();
      int d2 = d.dayInYear();
      ...
      for (int i = priorYear; i < latterYear; i++){
        if (isLeapYear(i)) difference += 366;
        else difference += 365;
        
      }

      difference-=priorDays;
      difference+=latterDays;
      return difference * before;                           // replace this line with your solution
  }
