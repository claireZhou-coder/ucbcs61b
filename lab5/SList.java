...
public class SList {
  ...
  public static void main (String[] args) {
    ...
    // SList solution = new SList();
    // solution.insertEnd(new Integer(9));
    // solution.insertEnd(new Integer(12));
    // solution.insertEnd(new Integer(15));
    // System.out.println("my solution list should be [  9  12  15  ]: " + solution);

    // solution.insertFront(new Integer(6));
    // solution.insertFront(new Integer(3));

    // System.out.println("my solution list should be [  3  6  9  12  15  ]: " + solution);
  ...
  //   lst1.insertEnd(new Integer(8));
  //   System.out.println("Here is the same list after insertEnd(8): "
  //          + lst1.toString());
  //   TestHelper.verify(lst1.toString().equals("[  5  6  7  8  ]"),
  //         "insertEnd after insertEnd failed");
  // }
}
